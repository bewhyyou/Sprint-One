...
//  private static String DATABASE_URL = "jdbc:derby:/Users/Rebecca Tyler/MyStuff;create=true";
...
//	private static final int MAX_CONNECTIONS = 1;
  ...
  private Connection createConnection() throws Exception {
    ...
    Connection conn = DriverManager.getConnection(DATABASE_URL, DATABASE_USERNAME, DATABASE_PASSWORD); //was: (DATABASE_URL, DATABASE_USERNAME, DATABASE_PASSWORD);
