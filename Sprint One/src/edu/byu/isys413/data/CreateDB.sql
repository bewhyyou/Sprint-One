...
INSERT INTO businessobject(id, botype) VALUES ('person1', 'edu.byu.isys413.rtyler1.Person'); --person1 business object
INSERT INTO person(id, firstname, lastname, phone) VALUES ('person1', 'Lisa', 'Simpson', '801-555-1234'); --person1 person object
INSERT INTO businessobject(id, botype) VALUES ('person2', 'edu.byu.isys413.rtyler1.Person');
...
INSERT INTO businessobject(id, botype) VALUES ('employee1', 'edu.byu.isys413.rtyler1.Employee');
...
INSERT INTO businessobject(id, botype) VALUES ('employee2', 'edu.byu.isys413.rtyler1.Employee');
...
INSERT INTO businessobject(id, botype) VALUES ('dog1', 'edu.byu.isys413.rtyler1.Dog');
INSERT INTO dog(id, personid, dogname, breed) VALUES ('dog1', 'person1', 'Fluffy', 'Great Dane');
INSERT INTO businessobject(id, botype) VALUES ('dog2', 'edu.byu.isys413.rtyler1.Dog');
INSERT INTO dog(id, personid, dogname, breed) VALUES ('dog2', 'person1', 'Dasher', 'Beagle');
INSERT INTO businessobject(id, botype) VALUES ('dog3', 'edu.byu.isys413.rtyler1.Dog');
INSERT INTO dog(id, personid, dogname, breed) VALUES ('dog3', 'employee1', 'Nacho',  'Bloodhound');
INSERT INTO businessobject(id, botype) VALUES ('dog4', 'edu.byu.isys413.rtyler1.Dog');
...
INSERT INTO businessobject(id, botype) VALUES ('car1', 'edu.byu.isys413.rtyler1.Car');
INSERT INTO car(id, brand, model) VALUES ('car1', 'Honda', 'Accord');
INSERT INTO businessobject(id, botype) VALUES ('car2', 'edu.byu.isys413.rtyler1.Car');
INSERT INTO car(id, brand, model) VALUES ('car2', 'Dodge', 'Ram');
INSERT INTO businessobject(id, botype) VALUES ('car3', 'edu.byu.isys413.rtyler1.Car');
...
-- This would be STOREPRODUCT
CREATE TABLE personcar (
  id           VARCHAR(40) PRIMARY KEY REFERENCES businessobject(id),
  carid        VARCHAR(40) REFERENCES car(id),
  ownerid      VARCHAR(40) REFERENCES person(id)
);
INSERT INTO businessobject(id, botype) VALUES ('personcar1', 'edu.byu.isys413.rtyler1.PersonCar');
INSERT INTO personcar(id, carid, ownerid) VALUES ('personcar1', 'car1', 'person1');
INSERT INTO businessobject(id, botype) VALUES ('personcar2', 'edu.byu.isys413.rtyler1.PersonCar');
INSERT INTO personcar(id, carid, ownerid) VALUES ('personcar2', 'car1', 'person2');
INSERT INTO businessobject(id, botype) VALUES ('personcar3', 'edu.byu.isys413.rtyler1.PersonCar');
INSERT INTO personcar(id, carid, ownerid) VALUES ('personcar3', 'car2', 'person2');
INSERT INTO businessobject(id, botype) VALUES ('personcar4', 'edu.byu.isys413.rtyler1.PersonCar');
