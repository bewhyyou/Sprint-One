...
//  double sal = 15000.0;
//  //GUI code
//  List<Employee> es = BusinessObjectDAO.getInstance().searchForList("Employee", 
//  SearchCriteria("salary", sal, SearchCriteria.GREATER_THAN_OR_EQUALS)); //list of business objects; multiple objects
//  
